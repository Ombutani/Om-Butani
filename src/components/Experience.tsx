...
const experiences = [
    {
        ...
        achievements: [
            "Worked on a team to develop a web application using React",
            "make a Responsive website using React",
            "Improved application performance by 40% through code optimization",
            "Mentored junior developers and conducted code reviews"
        ]
    },
    {
        title: "Intern Angular Developer",
        company: "ADIS Technologies",
        period: "January-2025 - March-2025",
        achievements: [
            "Worked on a team to develop a web application using Angular",
            "make a Responsive website using Tailwind and bootstrap",
            "Improved application performance by 40% through code optimization",
            "Mentored junior developers and conducted code reviews"
        ]
    },
...
"optimized code and improved application performance by 30%",
